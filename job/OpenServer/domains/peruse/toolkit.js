...
$(document).on('click.bs.tab.data-api','[data-toggle="tab"]',clickHandler).on('click.bs.tab.data-api','[data-toggle="pill"]',clickHandler)}(jQuery);+function($){'use strict';var dataApi='[data-transition="entrance"]'
...
return this}
$(function(){$(dataApi).enter()})}(jQuery);+function($){'use strict';var dataApi='[data-grid="images"]'
...
return this}
$(function(){$('[data-grid="images"]').imageGrid()})}(jQuery);+function($){"use strict";function ZoomService(){this._activeZoom=this._initialScrollPosition=this._initialTouchPosition=this._touchMoveListener=null
...
$(function(){new ZoomService().listen()})}(jQuery);+function($){'use strict';var dataApi='[data-toggle="stage"]'
