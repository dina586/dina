...
<div class = "b-ext_admin_menu_wrap">
	<ul id="ext_admin_menu">
		...
		<li>
			<a href = "<?=Yii::app()->createUrl('/shop/partner/admin')?>">Партнеры</a>
			<ul>
				<li><a href = "<?=Yii::app()->createUrl('/shop/partner/admin')?>">Управление</a></li>
				<li><a href = "<?=Yii::app()->createUrl('/shop/partner/create')?>">Добавить</a></li>
			</ul>
		</li>
		<li>
