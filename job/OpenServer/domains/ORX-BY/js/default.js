...
$('document').ready(function() {
	...
	$('.jqueryslidemenu li').each(function() { 		// Go through all the menu options		
	...
	$("a.big-button,a.medium-button").mouseenter(function() {
		...
		if($(this).hasClass('color') || $(this).parent('a').hasClass('color') )
			return;
		$(this).stop().animate({backgroundColor: '#283076'},200);
		$(this).children('span').stop().animate({backgroundColor: '#283076'},200);
	});
	/////////////////////////////////////////////
	// Search Field
	/////////////////////////////////////////////
