 ...
 *
 * The followings are the available columns in table '{{technics}}':
 * @property integer $id
 ...
 */
class Technics extends CActiveRecord
{
	 ...
	 * @return Technics the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('name, content, date, is_view', 'required'),
			...
			'imageBehavior' => array(
				...
				'data'=>array(
					'image'=>array(
						'width'=> self::WIDTH,
						'height'=> self::HEIGHT,
						'folder'=> Yii::app()->getModule('technics')->folder,
					),
				),
			),
			'cacheBehavior' =>array(
