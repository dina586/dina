...
class CFile extends CApplicationComponent
{
     ...
     * on fail.
     */
    public function createDir($directory=null, $permissions=0777)
    {
     ...
     */
    public function copy($fileDest, $rights)
    {
        ...
        else
        {
            ...
            foreach ($dirContents as $item) {
                ...
                elseif (is_dir($item))
                {
                    $this->createDir($itemDest, $rights);
                }
            }
	...
	public function getFileNames($directory, $allowed_types = array ('jpg', 'jpeg', 'gif', 'png')) {
		$file_parts = array ();
		$ext = '';
		$i = 0;
		$dir_handle = @opendir($directory) or die("Директория не найдена!");
