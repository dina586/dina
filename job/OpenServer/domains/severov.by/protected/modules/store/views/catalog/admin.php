...
$this->widget('bootstrap.widgets.BsGridView', array(
	...
	'columns'=>array(
		array(
			...
			'type' => 'raw',
			'filter' => '',
			'value' => 'Fields::gridImage("/upload/".Yii::app()->controller->module->catalogFolder."/".$data->id.".jpg", Yii::app()->createUrl("'.Yii::app()->controller->module->id.'/'.Yii::app()->controller->id.'/view",array("url" => $data->url)))',
