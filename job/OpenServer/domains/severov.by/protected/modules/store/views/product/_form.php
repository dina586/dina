...
<?php $form=$this->beginWidget('bootstrap.widgets.BsActiveForm', array(
	...
	<div class="l-row">
		...
		<p class = "l-hint">Цена вводится в $. Изменить курс пересчета можно здесь <a href = "<?=Yii::app()->createUrl('helper/settings/update', array('id'=>33));?>" target = "_blank"><?=Yii::app()->createAbsoluteUrl('helper/settings/update', array('id'=>33));?></a></p>
	</div>
	...
	<div class="l-row l-checkbox">
		<?php echo $form->checkBoxControlGroup($model,'popular',array('value' => '1', 'uncheckValue'=>'0')); ?>
	</div>
	
	<div class="l-row l-checkbox">
		<?php echo $form->checkBoxControlGroup($model,'is_new',array('value' => '1', 'uncheckValue'=>'0')); ?>
	</div>
	...
	$this->widget('file_uploader.UploadWidget', array(
		'postParams'=>array(
			'thumbnail'=>array('width'=>210, 'height'=>163),		
