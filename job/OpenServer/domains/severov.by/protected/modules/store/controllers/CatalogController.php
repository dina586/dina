...
class CatalogController extends Controller
{
	...
	public function actionView($url)
	{
		...
		$count = Catalog::model()->count('parent_id=:parent_id', array(':parent_id'=>$model->id));
		if($count==0):
			...
			$dataProvider = Catalog::model()->findAll(array('condition'=>'parent_id=:parent_id', 'params'=>array(':parent_id'=>$model->id), 'order'=>'name'));
			$this->ajaxRender('catalogs',array(
				'model'=>$model,
				'dataProvider'=> $dataProvider,
			));
		endif;
	...
	public function actionIndex()
	{
		...
		$dataProvider = Catalog::model()->findAll(array('condition'=>'parent_id=:parent_id', 'params'=>array(':parent_id'=>-1), 'order'=>'name'));
