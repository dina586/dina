...
<html lang="<?=Yii::app()->language; ?>">
    ...
    <body>
		...
		if(Yii::app()->user->checkAccess('admin'))
		  $this->renderPartial('//layouts/parts/_site_admin_menu');
			...
			<header id="header" class="navbar-static-top">
				<div class="topnav hidden-xs">
					<div class="container">
						...
						<div class="hlogreg">
							<div class="call_now">	
								<p><img src="../images/phone.png" alt="tel." /> ЗВОНИТЕ СЕЙЧАС  <a href = "tel:<?=Settings::getVal('header_phone')?>"><?=Settings::getVal('header_phone')?></a></p>
							</div>
							<div class="entlog">
								<ul class="quick-menu pull-right hreg ">
									<li class="flog"><a class="/soap-popupbox login" href="/user/auth/login">ВХОД</a></li>
									<li class="freg"><a class="/soap-popupbox registration" href="<?=Yii::app()->createUrl('/contacts');?>">КОНТАКТЫ</a></li>
                                                        ...
                                                        <ul class="">
                                                            <li class="bluecolor">                                                                
                                                                <div class="b-header_get_call">
                                                                    <a href="#" class="j-show_call_dialog btn-sm">Форма заказа</a>
                                                                </div>
                                                            </li>
                                                            <li class="orangecolor"><a  href="<?=Yii::app()->createUrl('/contacts');?>">Контакты</a></li>
