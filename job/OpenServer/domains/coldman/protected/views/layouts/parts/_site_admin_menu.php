    ...
    'items' => array(
        array(
            ...
            'items' => array(
                ...
                array(
            		'label' => Yii::t('admin', 'Продукты и решения'),
            		'url' => array('/product/view/create'),
            		'items' => array(
            			array('label' => Yii::t('main', 'Create'), 'url' => array('/product/view/create'), 'icon'=>BsHtml::GLYPHICON_LIST),
            			array('label' => Yii::t('main', 'Manage'), 'url' => array('/product/view/admin'), 'icon'=>BsHtml::GLYPHICON_LIST),            			
            		),
            	),
            	/* Template
            	array(
