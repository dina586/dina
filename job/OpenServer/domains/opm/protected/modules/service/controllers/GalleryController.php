...
class GalleryController extends Controller
{
	...
	public function titles(){
		switch(Yii::app()->controller->action->id){
			case 'create':
				return Yii::t('admin', 'Create new Gallery');
				break;
					
			case 'update':
				return Yii::t('admin', 'Edit Gallery');
				break;
					
			case 'admin':
				return Yii::t('admin', 'Manage Galleries');
				break;
	...
	{
		$this->seo(Helper::seoPage($this->titles(), 'Gallery_page'), '', Helper::seoPage($this->titles(), 'Gallery_page'));
		return true;
	}
