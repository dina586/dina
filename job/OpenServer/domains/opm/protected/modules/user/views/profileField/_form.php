...
<?php echo CHtml::beginForm(); ?>
	...
	<div class="l-row varname">
		...
		<p class="l-hint"><?php echo UserModule::t("Allowed lowercase letters and digits."); ?></p>
	</div>

	<div class="l-row title">
		<?php echo CHtml::activeLabelEx($model,'title'); ?>
		<?php echo CHtml::activeTextField($model,'title',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo CHtml::error($model,'title'); ?>
		<p class="l-hint"><?php echo UserModule::t('Field name on the language of "sourceLanguage".'); ?></p>
	</div>

	<div class="l-row field_type">
		...
		<p class="l-hint"><?php echo UserModule::t('Field type column in the database.'); ?></p>
	</div>

	<div class="l-row field_size">
		...
		<p class="l-hint"><?php echo UserModule::t('Field size column in the database.'); ?></p>
	</div>

	<div class="l-row field_size_min">
		...
		<p class="l-hint"><?php echo UserModule::t('The minimum value of the field (form validator).'); ?></p>
	</div>

	<div class="l-row required">
		...
		<p class="l-hint"><?php echo UserModule::t('Required field (form validator).'); ?></p>
	</div>

	<div class="l-row match">
		...
		<p class="l-hint"><?php echo UserModule::t("Regular expression (example: '/^[A-Za-z0-9\s,]+$/u')."); ?></p>
	</div>

	<div class="l-row range">
		...
		<p class="l-hint"><?php echo UserModule::t('Predefined values (example: 1;2;3;4;5 or 1==One;2==Two;3==Three;4==Four;5==Five).'); ?></p>
	</div>

	<div class="l-row error_message">
		...
		<p class="l-hint"><?php echo UserModule::t('Error message when you validate the form.'); ?></p>
	</div>

	<div class="l-row other_validator">
		...
		<p class="l-hint"><?php echo UserModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('file'=>array('types'=>'jpg, gif, png'))))); ?></p>
	</div>

	<div class="l-row default">
		...
		<p class="l-hint"><?php echo UserModule::t('The value of the default field (database).'); ?></p>
	</div>

	<div class="l-row widget">
		...
		<p class="l-hint"><?php echo UserModule::t('Widget name.'); ?></p>
	</div>

	<div class="l-row widgetparams">
		...
		<p class="l-hint"><?php echo UserModule::t('JSON string (example: {example}).',array('{example}'=>CJavaScript::jsonEncode(array('param1'=>array('val1','val2'),'param2'=>array('k1'=>'v1','k2'=>'v2'))))); ?></p>
	</div>

	<div class="l-row position">
		...
		<p class="l-hint"><?php echo UserModule::t('Display order of fields.'); ?></p>
	</div>

	<div class="l-row visible">
