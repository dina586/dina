...
class ProfileFieldController extends Controller
{
	...
	public function titles(){
		switch(Yii::app()->controller->action->id){
			case 'create':
				return Yii::t('admin', 'Create new profile field');
				break;
					
			case 'update':
				return Yii::t('admin', 'Edit profile field');
				break;
					
			case 'admin':
				return Yii::t('admin', 'Manage profile fields');
				break;
			case 'view':
				return Yii::t('admin', 'View field details');
				break;
		}
	}
