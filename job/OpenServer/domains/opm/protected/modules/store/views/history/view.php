<div class = "col-md-6">
	<h2 class = "b-history_title"><?=Yii::t('shop', 'Order Details');?></h2>
	...
	<p class = "l-hint"><?=Yii::t('shop', 'Payment information is available only if payment system connected');?></p>
	...
	foreach($productData as $product) { 
		...
		<div class = "b-store_history_product">
			...
			<div class = "b-store_history_description l-inline_block">
				<?=$name?>
				<p><b><?=Yii::t('shop', 'Price per unit')?></b>: $ <?=StoreHelper::viewPrice($product['cost']);?></p>
