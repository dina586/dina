...
<div class="row">
	...
	<div class="col-md-3">
		...
		<div class="widget widget-default widget-item-icon">
			...
			<div class="widget-data">
				<div class="widget-int num-count"><?=User::getUserCount(); ?></div>
...
<script type="text/javascript" src="/themes/crm/js/plugins/mcustomscrollbar/jquery.mCustomScrollbar.min.js"></script>
