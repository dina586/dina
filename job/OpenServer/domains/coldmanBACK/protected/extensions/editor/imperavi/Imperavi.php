 ...
 */
class Imperavi extends CInputWidget
{
	/**
	 * Assets package ID.
	 */
	...
	public $pluginPackage = array(
		'fontsize' => array(
			'basePath' => 'ext.editor.imperavi.assets.plugins.fontsize',
			'js' => array('fontsize.js',),
		),
		'fullscreen' => array(
			'basePath' => 'ext.editor.imperavi.assets.plugins.fullscreen',
			'js' => array('fullscreen.js',),
		),
		'fontfamily' => array(
			'basePath' => 'ext.editor.imperavi.assets.plugins.fontfamily',
	...
	protected function registerClientScript()
	{
		...
		if (Yii::app()->language !== 'en') {
			$this->package['js'][] = 'lang/' . Yii::app()->language . '.js';
		}
