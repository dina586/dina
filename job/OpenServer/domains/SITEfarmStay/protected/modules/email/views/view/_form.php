...
<?php $form=$this->beginWidget('bootstrap.widgets.BsActiveForm', array(
	...
	<?php if(!$model->isNewRecord):?>
		<div class = "l-row">
			...
			<p class = "l-hint">
				...
				<a target = "_blank" href = "<?=Yii::app()->createUrl('helper/settings/update', array('id'=>8))?>"><?=Yii::t('admin', 'Edit email')?></a>
			</p>
		</div>
	<?php endif;?>
	...
	<div class="l-row">
		...
		<a target = "_blank" href = "<?=Yii::app()->createUrl('helper/settings/update', array('id'=>11))?>"><?=Yii::t('admin', 'here')?></a>
		</p>
	</div>
	...
	<div class="l-row">
		...
		<p class = "l-hint">
			...
			<a target = "_blank" href = "<?=Yii::app()->createUrl('helper/settings/update', array('id'=>12))?>"><?=Yii::t('admin', 'here')?></a>
		</p>
	</div>
	...
	<div class="l-row l-checkbox">
		...
		<p class = "l-hint">
			...
			<a target = "_blank" href = "<?=Yii::app()->createUrl('helper/settings/update', array('id'=>4))?>"><?=Yii::t('admin', 'here')?></a>
		</p>
	</div>
	...
	<div class="l-row l-checkbox">
		...
		<p class = "l-hint">
			...
			<a target = "_blank" href = "<?=Yii::app()->createUrl('helper/settings/update', array('id'=>5))?>"><?=Yii::t('admin', 'here')?></a>
		</p>
	</div>
