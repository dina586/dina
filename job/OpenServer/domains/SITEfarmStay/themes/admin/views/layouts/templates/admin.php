							...
							<div class="sidebar-section sidebar-user clearfix sidebar-nav-mini-hide">
								<div class="sidebar-user-avatar">
									<a href="<?=Yii::app()->createUrl('/user/view/profile')?>">
										<img src="<?= Yii::app()->theme->baseUrl ?>/img/placeholders/avatars/avatar2.jpg" alt="avatar">
									</a>
								</div>
						...
						<ul class="nav navbar-nav-custom pull-right">
							...
							<li class="dropdown">
								<a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown">
									<img src="<?= Yii::app()->theme->baseUrl ?>/img/placeholders/avatars/avatar2.jpg" alt="avatar"> <i class="fa fa-angle-down"></i>
								</a>
