...
$this->widget('application.modules.admin.components.AdminMenu', [
	...
	'items' => [
        ...
        array(
			'label' => Yii::t('admin', 'Offers'),
			'url' => ['/offers/view/admin'],
			'icon' => 'fa fa-list-alt',
		),
		array(
			'label' => Yii::t('admin', 'Chance'),
			'url' => ['/chance/view/admin'],
			'icon' => 'fa fa-list-alt',
		),
        array(
			'label' => Yii::t('admin', 'Products'), 
			'url' => ['/product/view/admin'], 
			'icon' => 'fa fa-list-alt',
		),
		array(
			'label' => Yii::t('admin', 'Coupons'), 
			'url' => ['/coupons/view/admin'], 
			'icon' => 'fa fa-list-alt',
		),
		array(
			'label' => Yii::t('admin', 'Gallery'), 
			'url' => ['/gallery/view/admin'], 
			'icon' => 'fa fa-list-alt',
		),
		array(
			'label' => 'Site Settings',
