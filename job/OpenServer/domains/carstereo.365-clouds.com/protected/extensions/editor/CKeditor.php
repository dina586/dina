...
class CKeditor extends CInputWidget {
	 ...
	 * editing area.
	 */
	public $bodyClass = 'b-admin_editor g-styles';
	 ...
	 */
	public $contentsCss = array('/css/main.css', '/css/system.css');
	...
	protected function _ckeGenerateConfig() {
		...
		$this->filebrowserImageBrowseUrl = Yii::app()->baseUrl.'/packages/editor/kcfinder/browse.php?type=files';
		$this->filebrowserImageUploadUrl = Yii::app()->baseUrl.'/packages/editor/kcfinder/upload.php?type=files';
