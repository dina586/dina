...
$this->widget('application.modules.admin.components.AdminMenu', [
	...
	'items' => [
		...
		array(
			...
			'url' => ['/helper/default/cerf'],
		),
		array(
			'label' => Yii::t('admin', 'Загрузка в обучение'),
			'url' => ['/helper/default/teach'],
		),
	],
]);
