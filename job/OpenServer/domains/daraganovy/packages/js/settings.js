var udt_global_vars = {
	...
	"thumb_rollover_opacity":"0.7",
	// Value between 0 and 15. E.g. 10
	"thumb_rollover_padding":"5",
	// Value between 1.0 and 1.5
	"thumb_rollover_zoom_factor":"1.2",
	// URL to rollover graphic
	"rollover_graphic":"images/logo-rollover.png",

	/* Epic Fullscreen Background IMage Settings */
	// Value between 0 and 1. E.g. 0.5
	"background_image_opacity":"1",
	// Possible values: true, false.
	"background_image_overlay_pattern_on_off":true,

	/* Frontpage Epic Slider Settings */
	// Possible values: true, false.
	"frontpage_slider_overlay_pattern_on_off":true,
	// Possible values: true, false.
	...
	"frontpage_slider_easing":"easeInOutQuint",
	// Possible values: true, false.
	"frontpage_slider_mute_background_video":true,

	/* Blog Post Epic Slider Settings */
	// Possible values: true, false.
	"post_slider_overlay_pattern_on_off":false,
	// Possible values: true, false.
	"post_slider_slideshow":false,
	// Possible values: true, false.
	"post_slider_autoplay":true,
	// Possible values: true, false.
	"post_slider_fullscreen_button":false,
	// Possible values: true, false.
	"post_slider_crop_to_fit":false,
	// Possible values: "arrows", "bullets".
	"post_slider_navigation_style":"arrows",
	// Value in milliseconds
	"post_slider_slide_timer":"3000",
	// Value in milliseconds
	"post_slider_slide_animation_speed":"600",
	// Possible Values: "none", "fade", "leftToRight", "topToBottom".
	"post_slider_slide_animation":"leftToRight",
	// Possible Values: "none", "fade", "leftToRight", "topToBottom".
	"post_slider_mobile_slide_animation":"fade",
	// Easing Type as available in the jQuery Easing Plugin: http://gsgd.co.uk/sandbox/jquery/easing/
	"post_slider_easing":"easeInOutQuint",
	// Possible values: true, false.
	"post_slider_mute_background_video":true,
	
	/* Portfolio Epic Slider Settings */
	// Possible values: true, false.
	"epic_slider_overlay_pattern_on_off":false,
	// Possible values: true, false.
	"epic_slider_slideshow":false,
	// Possible values: true, false.
	"epic_slider_autoplay":false,
	// Possible values: true, false.
	"epic_slider_fullscreen_button":true,
	// Possible values: true, false.
	"epic_slider_crop_to_fit":false,
	// Possible values: "arrows", "bullets".
	...
	// Possible Values: "none", "fade", "leftToRight", "topToBottom".
	"epic_slider_mobile_slide_animation":"fade",
	// Easing Type as available in the jQuery Easing Plugin: http://gsgd.co.uk/sandbox/jquery/easing/
	"epic_slider_easing":"easeInOutQuint",
	// Possible values: true, false.
	...
	// Possible values: true, false.
	"map_controls":true,
	"map_image_marker":"images/ui/map-marker.png"
};