...
"%windir%\system32\icacls.exe"  "%windir%\system32\drivers\etc\hosts" /c /remove:d "%USERNAME%"   2>nul >nul
"%windir%\system32\icacls.exe"  "%windir%\system32\drivers\etc\hosts" /c /grant:r  "%USERNAME%":F 2>nul >nul
